...
var ReactPannellum = /*#__PURE__*/function (_React$Component) {
  ...
  function ReactPannellum() {
    ...
    _this.init = function () {
      ...
      _this.props.onPanoramaError && myPannellum.on("error", function (event) {
        return _this.props.onPanoramaError(event);
      });
    };
  ...
  _createClass(ReactPannellum, [{
    ...
    value: function componentWillUnmount() {
      ...
      if (myPannellum) {
        ...
        this.props.onPanoramaError && myPannellum.off("error", function (event) {
          return _this3.props.onPanoramaError;
        });
      }
    }
  }, {
...
ReactPannellum.propTypes = {
  ...
  onPanoramaError: PropTypes__default['default'].func
};
